...
document.getElementById("closeWindowBtn").addEventListener("click", closeBJWindow)
...
document.getElementById("InstaWindowBtn").addEventListener("click", InstaWindow);
document.getElementById("closeInstaBtn").addEventListener("click", closeInstaWindow)
...
document.getElementById("closeWalBtn").addEventListener("click", closeWalWindow)
